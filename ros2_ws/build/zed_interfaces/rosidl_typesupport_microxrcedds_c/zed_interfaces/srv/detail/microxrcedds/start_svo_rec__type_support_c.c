...
#include "zed_interfaces/srv/detail/start_svo_rec__rosidl_typesupport_microxrcedds_c.h"
...
typedef zed_interfaces__srv__StartSvoRec_Request _StartSvoRec_Request__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _StartSvoRec_Request__ros_msg_type * ros_message = (_StartSvoRec_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  rv = ucdr_serialize_bool(cdr, (ros_message->input_transcode) ? 0x01 : 0x00);
  // Member: svo_filename
 {
    uint32_t string_len = (ros_message->svo_filename.data == NULL) ? 0 : (uint32_t)strlen(ros_message->svo_filename.data) + 1;
    ros_message->svo_filename.size = (ros_message->svo_filename.data == NULL) ? 0 : string_len - 1 ;
    rv = ucdr_serialize_sequence_char(cdr, ros_message->svo_filename.data, string_len);
  }
  ...
  void * untyped_ros_message)
{
  ...
  {
    size_t capacity = ros_message->svo_filename.capacity;
    uint32_t string_size;
    rv = ucdr_deserialize_sequence_char(cdr, ros_message->svo_filename.data, capacity, &string_size);
    if (rv) {
      ros_message->svo_filename.size = (string_size == 0) ? 0 : string_size - 1;
    } else if(string_size > capacity){
      cdr->error = false;
      cdr->last_data_size = 1;
      ros_message->svo_filename.size = 0;
  ...
  size_t current_alignment)
{
  ...
  const _StartSvoRec_Request__ros_msg_type * ros_message = (const _StartSvoRec_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_zed_interfaces__srv__StartSvoRec_Request(&full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, zed_interfaces, srv, StartSvoRec_Request)() {
...
typedef zed_interfaces__srv__StartSvoRec_Response _StartSvoRec_Response__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _StartSvoRec_Response__ros_msg_type * ros_message = (_StartSvoRec_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _StartSvoRec_Response__ros_msg_type * ros_message = (const _StartSvoRec_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_zed_interfaces__srv__StartSvoRec_Response(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, zed_interfaces, srv, StartSvoRec_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, zed_interfaces, srv, StartSvoRec)() {
