...
#include "zed_interfaces/msg/detail/bounding_box2_df__rosidl_typesupport_microxrcedds_c.h"
...
typedef zed_interfaces__msg__BoundingBox2Df _BoundingBox2Df__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _BoundingBox2Df__ros_msg_type * ros_message = (_BoundingBox2Df__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _BoundingBox2Df__ros_msg_type * ros_message = (const _BoundingBox2Df__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _BoundingBox2Df__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_zed_interfaces__msg__BoundingBox2Df(&full_bounded, 0);
}
