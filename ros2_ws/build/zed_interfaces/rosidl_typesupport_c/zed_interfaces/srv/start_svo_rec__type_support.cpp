...
static const _StartSvoRec_Request_type_support_symbol_names_t _StartSvoRec_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, StartSvoRec_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_interfaces, srv, StartSvoRec_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, zed_interfaces, srv, StartSvoRec_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zed_interfaces, srv, StartSvoRec_Request)() {
  return &::zed_interfaces::srv::rosidl_typesupport_c::StartSvoRec_Request_message_type_support_handle;
}
...
static const _StartSvoRec_Response_type_support_symbol_names_t _StartSvoRec_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, StartSvoRec_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_interfaces, srv, StartSvoRec_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, zed_interfaces, srv, StartSvoRec_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_zed_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zed_interfaces, srv, StartSvoRec_Response)() {
  return &::zed_interfaces::srv::rosidl_typesupport_c::StartSvoRec_Response_message_type_support_handle;
}
...
static const _StartSvoRec_type_support_symbol_names_t _StartSvoRec_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_interfaces, srv, StartSvoRec)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_interfaces, srv, StartSvoRec)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, zed_interfaces, srv, StartSvoRec)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, zed_interfaces, srv, StartSvoRec)() {
  return &::zed_interfaces::srv::rosidl_typesupport_c::StartSvoRec_service_type_support_handle;
}
