...
static const _SetPose_Request_type_support_symbol_names_t _SetPose_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, zed_interfaces, srv, SetPose_Request)),
  }
};
...
static const _SetPose_Response_type_support_symbol_names_t _SetPose_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, zed_interfaces, srv, SetPose_Response)),
  }
};
...
static const _SetPose_type_support_symbol_names_t _SetPose_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, zed_interfaces, srv, SetPose)),
  }
};
