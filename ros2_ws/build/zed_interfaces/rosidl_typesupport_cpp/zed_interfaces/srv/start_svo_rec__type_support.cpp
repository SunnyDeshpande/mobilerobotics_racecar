...
static const _StartSvoRec_Request_type_support_symbol_names_t _StartSvoRec_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, zed_interfaces, srv, StartSvoRec_Request)),
  }
};
...
static const _StartSvoRec_Response_type_support_symbol_names_t _StartSvoRec_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, zed_interfaces, srv, StartSvoRec_Response)),
  }
};
...
static const _StartSvoRec_type_support_symbol_names_t _StartSvoRec_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, zed_interfaces, srv, StartSvoRec)),
  }
};
