...
class LaneDetector(Node):
    def __init__(self):
        ...
        self.dist_scale_factor = 1.0
        self.steer_scale_factor = 0.1
        ...
        # Numeric publishers
        self.cmd_vel_pub = self.create_publisher(Twist, '/temp/cmd_vel', QoSProfile(depth=10, reliability=ReliabilityPolicy.RELIABLE))
    ...
    def lane_centroid_callback(self, msg: Point):
        ...
        dist_scale = max(1.0, self.dist_scale_factor*dist_from_robot)
